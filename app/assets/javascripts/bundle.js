...
/* harmony import */ var _red_png__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_red_png__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _blue_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./blue.png */ "./src/blue.png");
/* harmony import */ var _blue_png__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_blue_png__WEBPACK_IMPORTED_MODULE_3__);
  ...
  _createClass(App, [{
    ...
    value: function componentWillMount() {
      if (!document.cookie) {
        ...
        var _cookie = this.getCookie(document.cookie);

        this.updateUser(_cookie);
        setTimeout(function () {
          that.getUser(_cookie);
        }, 100);
      }
    }
  }, {
    key: "generateCookie",
    value: function generateCookie() {
      var num = Math.floor(Math.random() * 10000);
      var timeStamp = new Date();
      document.cookie = "cookie=".concat(num).concat(timeStamp.getTime());
    }
  }, {
    key: "getCookie",
    value: function getCookie(cookie) {
    ...
    key: "getUser",
    value: function getUser(cookie) {
      var that = this;
      $.ajax({
        url: "api/users/".concat(cookie),
        type: "GET",
        dataType: "json",
    ...
    key: "updateUser",
    value: function updateUser(cookie) {
      $.ajax({
        method: "PATCH",
        url: "api/users/".concat(cookie),
        dataType: "json"
    ...
    value: function render() {
      ...
      if (this.state.ball === 1) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          ...
          className: "tally"
        }, "Current cookie's Red circle count: ", this.state.count));
      } else {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          id: "layout-content",
          className: "layout-content-wrapper"
          ...
          className: "tally"
        }, "Current cookie's Blue circle count: ", this.state.count));
      }
    }
  }]);
...
module.exports = __webpack_require__.p + "ca51c3f26a56d355867abd8fbdefcad1.png";
...
module.exports = __webpack_require__.p + "89fd19bc324e0e77ece6c79db1928d02.svg";
...
module.exports = __webpack_require__.p + "de61cc23de6793c98d171818f4662813.png";
